...
namespace LineUpHeros
{
    ...
    {
        // Vector3의 X,Y,Z 값을 바꾼 Vector3를 리턴하는 함수
        ...
        // 범위내 LayerMask해당되는 IDamagable리스트를 리턴하는 함수 (거리순 정렬 )
        ...
        // 범위내 LayerMask해당되는 T리스트를 리턴하는 함수 (거리순 정렬 )
        // gameobject.GetComponent로 불러올수 있는 컴포넌트만 됨, 인터페이스 안됨
